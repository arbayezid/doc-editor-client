                ...
                {faqs.map((faq, index) => (
                    <div key={index}>
                            ...
                            >
                                ...
                                <svg
                                    ...
                                    className={`w-3 h-3 rotate-180 shrink-0 ${
                                        accordionStates[index] ? 'transform rotate-0' : ''
                                    }`}
                                    aria-hidden="true"
                        ...
                        <div
                            ...
                            className= {`p-5 border border-b-0 border-gray-200 dark:border-red-700 dark:bg-gray-900 ${
                                accordionStates[index] ? '' : 'hidden'
                            }`}
