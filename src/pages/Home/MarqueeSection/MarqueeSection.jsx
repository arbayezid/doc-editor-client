...
//                 <div>
//                     <img src="https://i.ibb.co/6FRmks0/png-transparent-directory-icon-folder-miscellaneous-angle-rectangle-thumbnail.png" alt="Logo" className="h-16 mx-4" />
//                     <p className='text-xl text-center'>Folder</p>
//                 </div>
//                 <div>
//                     <img src="https://i.ibb.co/qsM8CM4/Google-Drive-icon-2020-svg.png" alt="Logo" className="h-16 mx-4" />
//                     <p className='text-xl text-center'>Drive</p>
//                 </div>
//                 <div>
//                     <img src="https://i.ibb.co/6RBC1Ks/Dropbox-Icon-svg.png" alt="Logo" className="h-16 mx-4" />
//                     <p className='text-xl text-center'>Dropbox</p>
//                 </div>
//                 <div>
//                     <img src="https://i.ibb.co/nkhWGMM/cloud.png" alt="Logo" className="h-16 mx-4" />
//                     <p className='text-xl text-center'>OneCloud</p>
//                 </div>
//                 <div>
//                     <img src="https://i.ibb.co/wr6Hmr8/doc.png" alt="Logo" className="h-16 mx-4" />
//                     <p className='text-xl text-center'>Word</p>
//                 </div>
//                 <div>
//                     <img src="https://i.ibb.co/S0YgBy5/doc2.png" alt="Logo" className="h-16 mx-4" />
//                     <p className='text-xl text-center'>Docs</p>
//                 </div>
//                 <div>
//                     <img src="https://i.ibb.co/6sXqBrH/PDF-file-icon-svg.png" alt="Logo" className="h-16 mx-4" />
//                     <p className='text-xl text-center'>PDF</p>
//                 </div>
//                 <div>
//                     <img src="https://i.ibb.co/SnR7qML/PPT-Logo-PNG-Pic.png" alt="Logo" className="h-16 mx-4" />
//                     <p className='text-xl text-center'>PPTX</p>
//                 </div>
//             </Marquee>
//         </div>
//     );
